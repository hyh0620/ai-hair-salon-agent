...
class UnrelatedHandler:
    ...
    def __init__(self, state_manager: StateManager):
        ...
        self._default_replies = [
            "抱歉，我无法处理这个问题。我只能帮您处理理发店服务相关的咨询和预约。",
            "很抱歉，我专门负责剪发、染发、烫发、造型等门店服务。如果您想了解服务内容或预约，我很乐意帮忙。",
            "对不起，这个问题超出了我的服务范围。我主要协助处理理发店预约和相关咨询。"
        ]
        self._reply_index = 0
    ...
    def set_business_context(self, service_name: str = "理发店服务") -> None:
        """设置业务上下文，自定义回复中的服务名称"""
        self._default_replies = [

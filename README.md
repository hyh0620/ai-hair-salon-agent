...
* [项目证据索引](docs/PROJECT_EVIDENCE.md)：按代码位置和验证命令核验项目能力；
* [项目路线图](docs/ROADMAP.md)：明确规划项、前置条件和完成标准；
...
评估语料包括 7 份源文档和 24 个语义切片。以上数字来自 2026-07-24 使用真实 LLM、Embedding、MCP/RAG 和隔离故障模式服务执行的[去敏快照](eval/snapshots/verified_20260724_4bbe6d6d.md)；28 条用例没有跳过项，JSON 明细已通过验证器重新计算。该结果不代表生产准确率或通用基准测试。详见[评估方法与结果](docs/EVALUATION.md)。
...
* [项目证据索引](docs/PROJECT_EVIDENCE.md)
